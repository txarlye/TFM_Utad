...
public class ObjectiveManager : Singleton<ObjectiveManager>
{
    ...
    private void PassThroughRings()
    {
        ...
        Vector3 spawnPosition = ringStartPoint.transform.position + Vector3.forward * distanceBetweenRings; // Puedes cambiar esto para que sea la posición inicial del jugador
    ...
    private IEnumerator CheckMissedRing()
    {
        ...
        currentObjectiveIndex = 0; // Usamos la variable de instancia para el índice del anillo actual
