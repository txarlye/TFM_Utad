...
public class Airplane_Attitude : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // Calcula la mitad del tamaño de bgRect y úsala como la altura máxima de cambio vertical
    ...
    public void HandleAirplaneUI()
    {
        ...
        // Aplicamos el cambio vertical al indicador de actitud
        /*
        Vector3 newPosition = bgRect.localPosition;
        newPosition.y = normalizedVerticalChange * maxVerticalChange;
        bgRect.localPosition = newPosition;
        */
        ...
        // Manejamos la rotación:
                ...
                if (bgRect)
                {
                    // Calculate the rotation for the roll angle (around the Z axis)
                    Quaternion rollRotation = Quaternion.Euler(0f, 0f, -rollAngle);

                    // Set the rotation of bgRect to the calculated roll rotation
