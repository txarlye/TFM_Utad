        ...
        if (currentObjective != null)
        {
            switch (currentMissionType)
            {
                case MissionManager.MissionType.DestroyTargets:
                    ...
                    targetPosition = currentObjective.GetTargetPosition(); // Asumiendo que tienes un método para obtener el objetivo actual
                    break;

                case MissionManager.MissionType.PassThroughRings:
                    Debug.Log("MinimapLine: caso PassThroughRings");
                    targetPosition = currentObjective.GetTargetPosition(); // Asumiendo que tienes un método para obtener el anillo actual
                    break;
